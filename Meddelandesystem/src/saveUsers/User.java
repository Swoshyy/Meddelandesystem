...
/**
 * Not complete user class, the User class in the displayUsersTest package is the complete version
 * If serialVersionUID is changed the input and outputstreams will not work?
 * @author sethoberg
 *
 */
