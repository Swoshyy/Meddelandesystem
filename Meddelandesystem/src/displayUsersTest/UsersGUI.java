...
/**
 * GUI for showing a list of users, two UsersGUI are used in the AllUsersGUI,
 * one list for online users and one for friends
 * 
 * @author sethoberg
 *
 */
...
public class UsersGUI extends JPanel
{
	...
	/**
	 * Method used when adding multiple users to the list of either online users or
	 * friends
	 * 
	 * @param userList
	 */
	public void addListOfUsers(LinkedList<User> userList)
	{
		...
		{
			if (!listModel.contains(userList.get(i)))
			{
