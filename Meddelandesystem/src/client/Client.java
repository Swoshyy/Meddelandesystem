			...
			try {
				...
				while (true) {
					...
					if (object instanceof Message) {
						...
						messageWindow.displayUser(user);
					}
						...
						if (status.getLoginStatus() == 1) {
							...
							messageWindow = new MessageWindow(controller, status.getLoggedInUser());
...
//							controller.closeSignUp(); 
						...
						LinkedList<ClientConnection> activeUsers = (LinkedList<ClientConnection>) listHolderObject
								.getUserList();
