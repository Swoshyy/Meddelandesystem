...
//		textArea.setWrapStyleWord(true);
	...
	/**
	 * Metoder för lista av användare
	 */
	
	public void addListOfUsers(LinkedList<User> list) {
		userListGUI.addListOfOnlineUsers(list);
	}
	
	public void addListOfFriends(LinkedList<User> list) {
		userListGUI.addListOfSavedFriends(list);
	}
